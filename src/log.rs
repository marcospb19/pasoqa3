...
///
/// 1. Some events (e.g. [`Event::PlayerJoined`]) are represented by multiple
/// messages.
...
pub enum Event {
    ...
    ///
    /// At match end, all joined players should be considered disconnected.
    ///
